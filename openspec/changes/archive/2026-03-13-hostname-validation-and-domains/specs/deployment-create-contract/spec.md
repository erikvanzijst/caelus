...
- **FROM:** Deployment write contracts exclude domainname across API and CLI
- **TO:** Deployment write contracts exclude hostname across API and CLI

### Requirement: Deployment reads continue returning domainname
- **FROM:** Deployment reads continue returning domainname
- **TO:** Deployment reads return hostname

### Requirement: Create service derives persisted domainname from template schema and user values
- **FROM:** Create service derives persisted domainname from template schema and user values
- **TO:** Create and update services derive hostname from template schema and user values
