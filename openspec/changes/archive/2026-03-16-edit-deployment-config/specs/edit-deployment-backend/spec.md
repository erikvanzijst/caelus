...
### deployment-create-contract: Deployment write contracts exclude hostname across API and CLI

#### Modified Scenario: Update payload allows same template version
