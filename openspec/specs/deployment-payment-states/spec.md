# deployment-payment-states Specification

## Purpose

Define the pending deployment status for paid plans, the complete deployment
state machine, reconciler behavior for pending deployments, and frontend
visual indicators for payment-related states.
