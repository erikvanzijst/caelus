...
Evaluate Prometheus alert rules for failing pods, unreachable nodes, high memory, and failed cronjobs, and deliver notifications by email through the existing in-cluster mailer relay.
