# mollie-webhook Specification

## Purpose

Define the POST /api/webhooks/mollie endpoint, first and recurring payment
handling, idempotency guarantees, and webhook lookup chains.
...
- **GIVEN** a monthly plan at EUR10/month
...
- **GIVEN** an annual plan at EUR120/year
- **AND** the first payment was made on 2026-03-23
- **WHEN** the Mollie subscription is created
