# product-visibility Specification

## Purpose

Defines the `visibility` column that controls whether a product is offered to
end users, its effect on the end-user product list versus administrative
listings, and why it remains editable for every product including curated
ones.
